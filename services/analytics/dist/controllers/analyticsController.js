...
class AnalyticsController {
    async trackEvent(req, res) {
        try {
            const { userId, sessionId, eventType, eventName, courseId, lessonId, assessmentId, properties } = req.body;
            ...
            await analyticsService_1.analyticsService.trackEvent(eventData);
            res.status(201).json({
                success: true,
    ...
    async getCourseAnalytics(req, res) {
        try {
            ...
            const analytics = await analyticsService_1.analyticsService.getCourseAnalytics(courseId, days);
            res.json({
                success: true,
                data: analytics,
            });
    ...
    async getUserProgress(req, res) {
        try {
            ...
            const progress = await analyticsService_1.analyticsService.getUserProgress(userId, courseId);
            res.json({
                success: true,
                data: progress,
            });
    ...
    async getDashboardAnalytics(req, res) {
        try {
            ...
            const analytics = await analyticsService_1.analyticsService.getDashboardAnalytics(days);
            res.json({
                success: true,
                data: analytics,
            });
    ...
    async updateUserProgress(req, res) {
        try {
            ...
            await analyticsService_1.analyticsService.updateUserProgress(userId, courseId, {
                lessonsCompleted,
                totalLessons,
                timeSpent,
                isCompleted,
    ...
    async processBatchedEvents(req, res) {
        try {
            await analyticsService_1.analyticsService.processBatchedEvents();
            res.json({
                success: true,
